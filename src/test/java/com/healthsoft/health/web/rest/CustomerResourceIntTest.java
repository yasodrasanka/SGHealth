...
import com.healthsoft.health.repository.CustomerRepository;
import com.healthsoft.health.service.CustomerService;
...
public class CustomerResourceIntTest {
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getFeatures()).isEqualTo(DEFAULT_FEATURES);
    }
    ...
    public void updateCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getFeatures()).isEqualTo(UPDATED_FEATURES);
    }
